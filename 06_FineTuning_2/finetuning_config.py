...
class Config:
    def __init__(self):
        """ Fine-tuning する元となるファイルを指定 """
        self.model_dir = 'best_model/best_model'  # newest file -> 'ls -ltr'
        # self.model_dir = 'model_8000/model_8000'
        # self.model_dir = 'scenario_7_model_1100/'
        # self.model_dir = 'models/model_3600/'
        ...
        self.num_update_cycles = 1000000  # default=1000000
        self.actor_rollouts_before_train = 20  # default=50 -> 20
        self.batch_size = 128  # Default=32
        self.num_minibatchs = 5  # bach_sizeのminibatchの数/1 update_cycle of learner, default=30
        self.tau = 0.01  # Soft update of target network
        self.gamma = 0.96
        self.max_steps = 120  # Default = 150 for pre-training, 200 for test
        ...
        """ Define scenario 1-9 """
        self.read_test_scenario(scenario_id=9)
