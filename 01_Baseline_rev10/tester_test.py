...
from battlefield_strategy_rev10_test import BattleFieldStrategy
...
def summarize_results(results):
    ...
    result['episode_team_reward'] = np.mean(results['episode_team_reward'])
...
class Tester:
    ...
    def test_play(self, current_weights, epsilon):
        ...
        for _ in range(self.env.config.max_episodes_test_play):
            ...
            while not dones['all_dones']:
                ...
                # reward:team reward, done: team done
                ...
                if dones['all_dones']:
                    ...
                    results['episode_team_reward'].append(episode_team_reward)
    ...
    def save_test_conds(self):
        test_conds = {
            ...
            'epsilon in epsilon_greedy': self.epsilon,
        }
...
def main():
    ...
    # Load model
    load_dir = Path(__file__).parent / 'trial(max_steps=150)/models'
    load_name = '/model_8000/model_8000'
    ...
    print(f" - mean_episode_team_reward = {result['episode_team_reward']}")
